...
<section class="about-profile" aria-labelledby="academic-profile">
  ...
  <aside class="about-snapshot" aria-label="Academic snapshot">
    ...
    <ul>
      ...
      <li>Cooperation and interdependence</li>
      <li>Emotion, resilience, and prosocial behavior</li>
      <li>Digital communication and joint decision-making</li>
      <li>Education, curriculum, and learning environments</li>
    </ul>
  </aside>
</section>

<section class="about-grid" aria-label="Research experience and skills">
  <article>
